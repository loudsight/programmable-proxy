[![Build Status](https://travis-ci.org/loudsight/programmable-proxy.png?branch=master)](https://travis-ci.org/loudsight/programmable-proxy)
...
```
$ git clone git://github.com/loudsight/programmable-proxy.git
$ cd LittleProxy
$ ./run.bash
```
